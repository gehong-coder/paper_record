...
class ComplexMultiply(torch.autograd.Function):
    ...
    def backward(ctx, grad_Z_re, grad_Z_im):
        ...
        return ComplexMultiply_backward(X_re, X_im, Y_re, Y_im, grad_Z_re,
                                        grad_Z_im)
...
class CompactBilinearPooling(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        return CompactBilinearPoolingFn.apply(self.sketch1.h, self.sketch1.s,
                                              self.sketch2.h, self.sketch2.s,
                                              self.output_size, x, y,
                                              self.force_cpu_scatter_add)
